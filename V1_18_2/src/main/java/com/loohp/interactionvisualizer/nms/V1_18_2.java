...
public class V1_18_2 extends NMSWrapper {
    ...
    public WrappedIterable<?, Entity> getEntities(World world) {
        ...
        return new WrappedIterable<>(worldServer.O.d().a(), net.minecraft.world.entity.Entity::getBukkitEntity);
    }
    ...
    public void spawnArmorStand(Collection<Player> players, ArmorStand entity) {
        try {
            ...
            spawnEntityLivingPacketFields[2].setInt(packet1, IRegistry.W.a(type));
