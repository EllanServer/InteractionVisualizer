...
public class V1_20 extends NMSWrapper {
    ...
    public Component getItemHoverName(ItemStack itemStack) {
        ...
        return GsonComponentSerializer.gson().deserialize(CraftChatMessage.toJSON(nmsItemStack.J()));
    }
    ...
    public String getBannerCustomName(Block block) {
        ...
        return tileEntity.ao_().l("CustomName");
    }
    ...
    public WrappedIterable<?, Entity> getEntities(World world) {
        try {
            ...
            if (worldServerEntityLookup == null) {
                return new WrappedIterable<>(worldServer.M.d().a(), net.minecraft.world.entity.Entity::getBukkitEntity);
            } else {
    ...
    public List<DataWatcher.b<?>> getWatchableCollection(ArmorStand stand) {
        try {
            ...
            dataWatcher.add(DataWatcher.b.a(EntityArmorStand.bD, headrotation));
            ...
            dataWatcher.add(DataWatcher.b.a(EntityArmorStand.bG, rightarmrotation));
