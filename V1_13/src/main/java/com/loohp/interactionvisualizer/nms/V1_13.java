...
public class V1_13 extends NMSWrapper {
    ...
    private final Field entityItemAgeField;
    ...
    public V1_13() {
        try {
            entityItemAgeField = EntityItem.class.getDeclaredField("age");
    ...
    public int getItemAge(Item item) {
        try {
            ...
            entityItemAgeField.setAccessible(true);
            return entityItemAgeField.getInt(entityItem);
    ...
    public PacketPlayOutEntityEquipment[] createEntityEquipmentPacket(int entityId, List<ValuePairs<EquipmentSlot, ItemStack>> equipments) {
        ...
        while (itr.hasNext()) {
            ...
            net.minecraft.server.v1_13_R1.ItemStack nmsItem = CraftItemStack.asNMSCopy(pair.getSecond());
    ...
    public int getItemDespawnRate(Item item) {
        int despawnRate;
        try {
            Object spigotWorldConfig = net.minecraft.server.v1_13_R1.World.class.getField("spigotConfig").get(((CraftWorld) item.getWorld()).getHandle());
    ...
    public String getBannerCustomName(Block block) {
        ...
        net.minecraft.server.v1_13_R1.TileEntity tileEntity = worldServer.getTileEntity(new net.minecraft.server.v1_13_R1.BlockPosition(block.getX(), block.getY(), block.getZ()));
        if (tileEntity == null) {
            return "";
        }
    ...
    public WrappedIterable<?, Entity> getEntities(World world) {
        try {
            ...
            Map<UUID, net.minecraft.server.v1_13_R1.Entity> entitiesByUUID = (Map<UUID, net.minecraft.server.v1_13_R1.Entity>) worldServerEntitiesByUUIDField.get(worldServer);
            return new WrappedIterable<>(entitiesByUUID.values(), net.minecraft.server.v1_13_R1.Entity::getBukkitEntity);
        } catch (IllegalAccessException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public List<DataWatcher.Item<?>> getWatchableCollection(com.loohp.interactionvisualizer.entityholders.Item item) {
        try {
            ...
            dataWatcher.add(new DataWatcher.Item<>((DataWatcherObject<net.minecraft.server.v1_13_R1.ItemStack>) dataWatcherItemItemField.get(null), CraftItemStack.asNMSCopy(item.getItemStack())));
    ...
    public List<DataWatcher.Item<?>> getWatchableCollection(ItemFrame frame) {
        try {
            ...
            dataWatcher.add(new DataWatcher.Item<>((DataWatcherObject<net.minecraft.server.v1_13_R1.ItemStack>) dataWatcherItemFrameItemField.get(null), CraftItemStack.asNMSCopy(frame.getItem())));
    ...
    public void spawnItem(Collection<Player> players, com.loohp.interactionvisualizer.entityholders.Item entity) {
        try {
            ...
            spawnEntityPacketFields[10].setInt(packet1, EntityTypes.REGISTRY.a(type));
