...
public class V1_16_4 extends NMSWrapper {
    ...
    public V1_16_4() {
        try {
            ...
            entityCountField = net.minecraft.server.v1_16_R3.Entity.class.getDeclaredField("entityCount");
            dataWatcherByteField = net.minecraft.server.v1_16_R3.Entity.class.getDeclaredField("S");
            dataWatcherCustomNameField = net.minecraft.server.v1_16_R3.Entity.class.getDeclaredField("aq");
            dataWatcherCustomNameVisibleField = net.minecraft.server.v1_16_R3.Entity.class.getDeclaredField("ar");
            dataWatcherSilentField = net.minecraft.server.v1_16_R3.Entity.class.getDeclaredField("as");
            dataWatcherNoGravityField = net.minecraft.server.v1_16_R3.Entity.class.getDeclaredField("at");
    ...
    public PacketPlayOutEntityEquipment[] createEntityEquipmentPacket(int entityId, List<ValuePairs<EquipmentSlot, ItemStack>> equipments) {
        List<Pair<EnumItemSlot, net.minecraft.server.v1_16_R3.ItemStack>> nmsEquipments = new ArrayList<>();
    ...
    public String getBannerCustomName(Block block) {
        ...
        net.minecraft.server.v1_16_R3.TileEntity tileEntity = worldServer.getTileEntity(new net.minecraft.server.v1_16_R3.BlockPosition(block.getX(), block.getY(), block.getZ()));
        if (tileEntity == null) {
            return "";
        }
    ...
    public WrappedIterable<?, Entity> getEntities(World world) {
        ...
        return new WrappedIterable<>(worldServer.entitiesById.values(), net.minecraft.server.v1_16_R3.Entity::getBukkitEntity);
    }
    ...
    public List<DataWatcher.Item<?>> getWatchableCollection(com.loohp.interactionvisualizer.entityholders.Item item) {
        try {
            ...
            dataWatcher.add(new DataWatcher.Item<>((DataWatcherObject<net.minecraft.server.v1_16_R3.ItemStack>) dataWatcherItemItemField.get(null), CraftItemStack.asNMSCopy(item.getItemStack())));
    ...
    public List<DataWatcher.Item<?>> getWatchableCollection(ItemFrame frame) {
        try {
            ...
            dataWatcher.add(new DataWatcher.Item<>((DataWatcherObject<net.minecraft.server.v1_16_R3.ItemStack>) dataWatcherItemFrameItemField.get(null), CraftItemStack.asNMSCopy(frame.getItem())));
