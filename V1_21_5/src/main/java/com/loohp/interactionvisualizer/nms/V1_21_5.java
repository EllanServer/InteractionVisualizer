...
public class V1_21_5 extends NMSWrapper {
    ...
    public String getBannerCustomName(Block block) {
        ...
        NBTBase nbtbase = tileEntity.a(worldServer.J_()).a("CustomName");
        if (nbtbase == null) {
            return "";
        }
        Optional<IChatBaseComponent> optChat = ComponentSerialization.a.parse(worldServer.J_().a(DynamicOpsNBT.a), nbtbase).resultOrPartial();
