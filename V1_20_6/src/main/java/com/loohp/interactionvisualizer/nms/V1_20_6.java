...
public class V1_20_6 extends NMSWrapper {
    ...
    public List<DataWatcher.c<?>> getWatchableCollection(ArmorStand stand) {
        try {
            ...
            dataWatcher.add(DataWatcher.c.a(EntityArmorStand.bG, standbitmask));
            ...
            dataWatcher.add(DataWatcher.c.a(EntityArmorStand.bH, headrotation));
            ...
            dataWatcher.add(DataWatcher.c.a(EntityArmorStand.bK, rightarmrotation));
    ...
    public List<DataWatcher.c<?>> getWatchableCollection(ItemFrame frame) {
        try {
            ...
            dataWatcher.add(DataWatcher.c.a(EntityItemFrame.g, CraftItemStack.asNMSCopy(frame.getItem())));
            dataWatcher.add(DataWatcher.c.a(EntityItemFrame.h, frame.getFrameRotation()));
