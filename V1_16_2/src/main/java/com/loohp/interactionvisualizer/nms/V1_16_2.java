...
public class V1_16_2 extends NMSWrapper {
    ...
    public PacketPlayOutEntityEquipment[] createEntityEquipmentPacket(int entityId, List<ValuePairs<EquipmentSlot, ItemStack>> equipments) {
        List<Pair<EnumItemSlot, net.minecraft.server.v1_16_R2.ItemStack>> nmsEquipments = new ArrayList<>();
    ...
    public String getBannerCustomName(Block block) {
        ...
        net.minecraft.server.v1_16_R2.TileEntity tileEntity = worldServer.getTileEntity(new net.minecraft.server.v1_16_R2.BlockPosition(block.getX(), block.getY(), block.getZ()));
        if (tileEntity == null) {
            return "";
        }
    ...
    public WrappedIterable<?, Entity> getEntities(World world) {
        ...
        return new WrappedIterable<>(worldServer.entitiesById.values(), net.minecraft.server.v1_16_R2.Entity::getBukkitEntity);
    }
    ...
    public List<DataWatcher.Item<?>> getWatchableCollection(com.loohp.interactionvisualizer.entityholders.Item item) {
        try {
            ...
            dataWatcher.add(new DataWatcher.Item<>((DataWatcherObject<net.minecraft.server.v1_16_R2.ItemStack>) dataWatcherItemItemField.get(null), CraftItemStack.asNMSCopy(item.getItemStack())));
    ...
    public List<DataWatcher.Item<?>> getWatchableCollection(ItemFrame frame) {
        try {
            ...
            dataWatcher.add(new DataWatcher.Item<>((DataWatcherObject<net.minecraft.server.v1_16_R2.ItemStack>) dataWatcherItemFrameItemField.get(null), CraftItemStack.asNMSCopy(frame.getItem())));
