...
public class V1_19_4 extends NMSWrapper {
    ...
    public V1_19_4() {
        try {
            ...
            dataWatcherCustomNameField = net.minecraft.world.entity.Entity.class.getDeclaredField("aR");
            dataWatcherCustomNameVisibleField = net.minecraft.world.entity.Entity.class.getDeclaredField("aS");
            dataWatcherSilentField = net.minecraft.world.entity.Entity.class.getDeclaredField("aT");
            dataWatcherNoGravityField = net.minecraft.world.entity.Entity.class.getDeclaredField("aU");
    ...
    public int getItemAge(Item item) {
        return ((EntityItem) ((CraftItem) item).getHandle()).g;
    }
    ...
    public PacketPlayOutEntityMetadata createEntityMetadataPacket(int entityId, List<?> dataWatchers) {
        return new PacketPlayOutEntityMetadata(entityId, (List<DataWatcher.b<?>>) dataWatchers);
    }
    ...
    public String getBannerCustomName(Block block) {
        ...
        return tileEntity.aq_().l("CustomName");
    }
    ...
    public WrappedIterable<?, Entity> getEntities(World world) {
        try {
            ...
            if (worldServerEntityLookup == null) {
                return new WrappedIterable<>(worldServer.L.d().a(), net.minecraft.world.entity.Entity::getBukkitEntity);
            } else {
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<DataWatcher.b<?>> getWatchableCollection(ArmorStand stand) {
        try {
            ...
            dataWatcher.add(DataWatcher.b.a((DataWatcherObject<Optional<IChatBaseComponent>>) dataWatcherCustomNameField.get(null), customName == null ? Optional.empty() : Optional.ofNullable(CraftChatMessage.fromJSON(GsonComponentSerializer.gson().serialize(customName)))));

            dataWatcher.add(DataWatcher.b.a((DataWatcherObject<Boolean>) dataWatcherCustomNameVisibleField.get(null), stand.isCustomNameVisible()));
            dataWatcher.add(DataWatcher.b.a((DataWatcherObject<Boolean>) dataWatcherSilentField.get(null), stand.isSilent()));
            dataWatcher.add(DataWatcher.b.a((DataWatcherObject<Boolean>) dataWatcherNoGravityField.get(null), !stand.hasGravity()));
            ...
            dataWatcher.add(DataWatcher.b.a(EntityArmorStand.bB, standbitmask));
            ...
            dataWatcher.add(DataWatcher.b.a(EntityArmorStand.bC, headrotation));
            ...
            dataWatcher.add(DataWatcher.b.a(EntityArmorStand.bF, rightarmrotation));
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<DataWatcher.b<?>> getWatchableCollection(com.loohp.interactionvisualizer.entityholders.Item item) {
        try {
            List<DataWatcher.b<?>> dataWatcher = new ArrayList<>();
            ...
            dataWatcher.add(DataWatcher.b.a((DataWatcherObject<Boolean>) dataWatcherCustomNameVisibleField.get(null), item.isCustomNameVisible()));
            dataWatcher.add(DataWatcher.b.a((DataWatcherObject<Boolean>) dataWatcherNoGravityField.get(null), !item.hasGravity()));

            dataWatcher.add(DataWatcher.b.a((DataWatcherObject<net.minecraft.world.item.ItemStack>) dataWatcherItemItemField.get(null), CraftItemStack.asNMSCopy(item.getItemStack())));
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<DataWatcher.b<?>> getWatchableCollection(ItemFrame frame) {
        try {
            List<DataWatcher.b<?>> dataWatcher = new ArrayList<>();

            dataWatcherSilentField.setAccessible(true);

            dataWatcher.add(DataWatcher.b.a((DataWatcherObject<Boolean>) dataWatcherSilentField.get(null), frame.isSilent()));

            dataWatcher.add(DataWatcher.b.a(EntityItemFrame.g, CraftItemStack.asNMSCopy(frame.getItem())));
            dataWatcher.add(DataWatcher.b.a(EntityItemFrame.h, frame.getFrameRotation()));
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<DataWatcher.b<?>> createCustomNameWatchableCollection(Component name) {
        try {
            List<DataWatcher.b<?>> dataWatcher = new ArrayList<>();
            ...
            dataWatcher.add(DataWatcher.b.a((DataWatcherObject<Optional<IChatBaseComponent>>) dataWatcherCustomNameField.get(null), name == null ? Optional.empty() : Optional.ofNullable(CraftChatMessage.fromJSON(GsonComponentSerializer.gson().serialize(name)))));
    ...
    @SuppressWarnings("unchecked")
    @Override
    public List<DataWatcher.b<?>> resetCustomNameWatchableCollection(Entity entity) {
        try {
            List<DataWatcher.b<?>> dataWatcher = new ArrayList<>();
    ...
    public void spawnArmorStand(Collection<Player> players, ArmorStand entity) {
        ...
        List<DataWatcher.b<?>> watcher = (List<DataWatcher.b<?>>) entity.getDataWatchers();
    ...
    public void spawnItem(Collection<Player> players, com.loohp.interactionvisualizer.entityholders.Item entity) {
        ...
        EntityTypes<EntityItem> type = EntityTypes.ad;
        Vec3D velocity = new Vec3D(entity.getVelocity().getX(), entity.getVelocity().getY(), entity.getVelocity().getZ());
        PacketPlayOutSpawnEntity packet1 = new PacketPlayOutSpawnEntity(entity.getEntityId(), entity.getUniqueId(), entity.getLocation().getX(), entity.getLocation().getY(), entity.getLocation().getZ(), entity.getLocation().getPitch(), entity.getLocation().getYaw(), type, 0, velocity, entity.getLocation().getYaw());
    ...
    public void spawnItemFrame(Collection<Player> players, ItemFrame entity) {
        EntityTypes<EntityItemFrame> type = EntityTypes.af;
