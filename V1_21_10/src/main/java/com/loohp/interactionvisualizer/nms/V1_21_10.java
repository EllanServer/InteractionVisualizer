...
public class V1_21_10 extends NMSWrapper {
    ...
    public V1_21_10() {
        try {
            ...
            dataWatcherByteField = ReflectionUtils.findDeclaredField(net.minecraft.world.entity.Entity.class, DataWatcherObject.class, "DATA_SHARED_FLAGS_ID", "aA");
            dataWatcherCustomNameField = ReflectionUtils.findDeclaredField(net.minecraft.world.entity.Entity.class, DataWatcherObject.class, "DATA_CUSTOM_NAME", "bm");
            dataWatcherCustomNameVisibleField = ReflectionUtils.findDeclaredField(net.minecraft.world.entity.Entity.class, DataWatcherObject.class, "DATA_CUSTOM_NAME_VISIBLE", "bn");
            dataWatcherSilentField = ReflectionUtils.findDeclaredField(net.minecraft.world.entity.Entity.class, DataWatcherObject.class, "DATA_SILENT", "bo");
            dataWatcherNoGravityField = ReflectionUtils.findDeclaredField(net.minecraft.world.entity.Entity.class, DataWatcherObject.class, "DATA_NO_GRAVITY", "bp");
    ...
    public NMSTileEntitySet<?, ?> getTileEntities(ChunkPosition chunk, boolean load) {
        ...
        return new NMSTileEntitySet<>(nmsChunk.j, entry -> {
            net.minecraft.core.BlockPosition pos = entry.getKey();
            Material type = CraftMagicNumbers.getMaterial(entry.getValue().o().b());
    ...
    public String getBannerCustomName(Block block) {
        ...
        NBTBase nbtbase = tileEntity.a(worldServer.L_()).a("CustomName");
        if (nbtbase == null) {
            return "";
        }
        Optional<IChatBaseComponent> optChat = ComponentSerialization.a.parse(worldServer.L_().a(DynamicOpsNBT.a), nbtbase).resultOrPartial();
    ...
    public WrappedIterable<?, Entity> getEntities(World world) {
        try {
            ...
            if (worldServerEntityLookup == null) {
                levelEntityGetter = worldServer.M.e();
            } else {
    ...
    public List<DataWatcher.c<?>> getWatchableCollection(ArmorStand stand) {
        try {
            ...
            dataWatcher.add(DataWatcher.c.a(EntityArmorStand.n, standbitmask));
            ...
            dataWatcher.add(DataWatcher.c.a(EntityArmorStand.o, headrotation));
            ...
            dataWatcher.add(DataWatcher.c.a(EntityArmorStand.r, rightarmrotation));
    ...
    public List<DataWatcher.c<?>> getWatchableCollection(ItemFrame frame) {
        try {
            ...
            dataWatcher.add(DataWatcher.c.a(EntityItemFrame.c, CraftItemStack.asNMSCopy(frame.getItem())));
            dataWatcher.add(DataWatcher.c.a(EntityItemFrame.d, frame.getFrameRotation()));
    ...
    public void spawnArmorStand(Collection<Player> players, ArmorStand entity) {
        EntityTypes<EntityArmorStand> type = EntityTypes.h;
    ...
    public void spawnItem(Collection<Player> players, com.loohp.interactionvisualizer.entityholders.Item entity) {
        ...
        EntityTypes<EntityItem> type = EntityTypes.au;
        Vec3D velocity = new Vec3D(entity.getVelocity().getX(), entity.getVelocity().getY(), entity.getVelocity().getZ());
        PacketPlayOutSpawnEntity packet1 = new PacketPlayOutSpawnEntity(entity.getEntityId(), entity.getUniqueId(), entity.getLocation().getX(), entity.getLocation().getY(), entity.getLocation().getZ(), entity.getLocation().getPitch(), entity.getLocation().getYaw(), type, 0, velocity, entity.getLocation().getYaw());
    ...
    public void spawnItemFrame(Collection<Player> players, ItemFrame entity) {
        EntityTypes<EntityItemFrame> type = EntityTypes.aw;
