...
public class V1_19_3 extends NMSWrapper {
    ...
    public List<DataWatcher.b<?>> getWatchableCollection(ArmorStand stand) {
        try {
            ...
            dataWatcher.add(DataWatcher.b.a(EntityArmorStand.bG, standbitmask));
            ...
            dataWatcher.add(DataWatcher.b.a(EntityArmorStand.bH, headrotation));
            ...
            dataWatcher.add(DataWatcher.b.a(EntityArmorStand.bK, rightarmrotation));
    ...
    public List<DataWatcher.b<?>> getWatchableCollection(ItemFrame frame) {
        try {
            ...
            dataWatcher.add(DataWatcher.b.a(EntityItemFrame.ao, CraftItemStack.asNMSCopy(frame.getItem())));
            dataWatcher.add(DataWatcher.b.a(EntityItemFrame.ap, frame.getFrameRotation()));
    ...
    public void spawnItem(Collection<Player> players, com.loohp.interactionvisualizer.entityholders.Item entity) {
        ...
        EntityTypes<EntityItem> type = EntityTypes.U;
        Vec3D velocity = new Vec3D(entity.getVelocity().getX(), entity.getVelocity().getY(), entity.getVelocity().getZ());
        PacketPlayOutSpawnEntity packet1 = new PacketPlayOutSpawnEntity(entity.getEntityId(), entity.getUniqueId(), entity.getLocation().getX(), entity.getLocation().getY(), entity.getLocation().getZ(), entity.getLocation().getPitch(), entity.getLocation().getYaw(), type, 0, velocity, entity.getLocation().getYaw());
    ...
    public void spawnItemFrame(Collection<Player> players, ItemFrame entity) {
        EntityTypes<EntityItemFrame> type = EntityTypes.V;
