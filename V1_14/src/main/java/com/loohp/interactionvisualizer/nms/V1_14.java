...
public class V1_14 extends NMSWrapper {
    ...
    public V1_14() {
        try {
            ...
            entityCountField = net.minecraft.server.v1_14_R1.Entity.class.getDeclaredField("entityCount");
            dataWatcherByteField = net.minecraft.server.v1_14_R1.Entity.class.getDeclaredField("W");
            dataWatcherCustomNameField = net.minecraft.server.v1_14_R1.Entity.class.getDeclaredField("az");
            dataWatcherCustomNameVisibleField = net.minecraft.server.v1_14_R1.Entity.class.getDeclaredField("aA");
            dataWatcherSilentField = net.minecraft.server.v1_14_R1.Entity.class.getDeclaredField("aB");
            dataWatcherNoGravityField = net.minecraft.server.v1_14_R1.Entity.class.getDeclaredField("aC");
    ...
    public PacketPlayOutEntityEquipment[] createEntityEquipmentPacket(int entityId, List<ValuePairs<EquipmentSlot, ItemStack>> equipments) {
        ...
        while (itr.hasNext()) {
            ...
            net.minecraft.server.v1_14_R1.ItemStack nmsItem = CraftItemStack.asNMSCopy(pair.getSecond());
    ...
    public int getItemDespawnRate(Item item) {
        int despawnRate;
        try {
            Object spigotWorldConfig = net.minecraft.server.v1_14_R1.World.class.getField("spigotConfig").get(((CraftWorld) item.getWorld()).getHandle());
    ...
    public String getBannerCustomName(Block block) {
        ...
        net.minecraft.server.v1_14_R1.TileEntity tileEntity = worldServer.getTileEntity(new net.minecraft.server.v1_14_R1.BlockPosition(block.getX(), block.getY(), block.getZ()));
        if (tileEntity == null) {
            return "";
        }
    ...
    public WrappedIterable<?, Entity> getEntities(World world) {
        ...
        return new WrappedIterable<>(worldServer.entitiesById.values(), net.minecraft.server.v1_14_R1.Entity::getBukkitEntity);
    }
    ...
    public List<DataWatcher.Item<?>> getWatchableCollection(com.loohp.interactionvisualizer.entityholders.Item item) {
        try {
            ...
            dataWatcher.add(new DataWatcher.Item<>((DataWatcherObject<net.minecraft.server.v1_14_R1.ItemStack>) dataWatcherItemItemField.get(null), CraftItemStack.asNMSCopy(item.getItemStack())));
    ...
    public List<DataWatcher.Item<?>> getWatchableCollection(ItemFrame frame) {
        try {
            ...
            dataWatcher.add(new DataWatcher.Item<>((DataWatcherObject<net.minecraft.server.v1_14_R1.ItemStack>) dataWatcherItemFrameItemField.get(null), CraftItemStack.asNMSCopy(frame.getItem())));
